...
\begin{figure}[htbp!]
    \centering
    \subfigure[素颜\label{fig:sub1a}]{\includegraphics[width=0.5\textwidth]{china1.png}}\subfigure[彩妆\label{fig:sub2}]{\includegraphics[width=0.5\textwidth]{china2.png}}
    \caption{中国地图展示}
    \label{subfig_cn_map_example}
\end{figure}
